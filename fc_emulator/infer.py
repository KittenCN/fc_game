...
def main() -> None:
    ...
    parser.add_argument("--stagnation-frames", type=int, default=900, help="End episodes early if no forward progress for this many frames (0 disables).")
    parser.add_argument("--stagnation-progress", type=int, default=1, help="Minimum forward distance treated as progress when tracking stagnation.")
